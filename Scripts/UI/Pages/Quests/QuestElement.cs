...
namespace UI.Pages.Quests
{
    public class QuestElement : MonoBehaviour
    {
        ...
        [SerializeField] private Button _toggleSelectQuestButton;
        ...
        private void Start()
        {
            ...
            _toggleSelectQuestButton.onClick.AddListener(() =>
                {
                    switch (_quest.State)
                    {
        ...
        {
            _toggleSelectQuestButton.onClick.AddListener(() => onClick.Invoke());
        }
    }
}
